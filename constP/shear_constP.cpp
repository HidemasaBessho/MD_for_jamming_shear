...
int main()
{
  ...
  int list[Np][Nn];
  double txy=0.0,txy0=0.0,P=0.0,U=0.0,dt=0.01,phi0=0.86,gap=0.0,t,gamma=0.0,d_gamma=1.e-5;
  double L = sqrt(M_PI*Np/2.0*(a1*a1+a2*a2)/4.0/phi0),disp_max=0.0,sampling_time=5.0*dt,time_max=1.0/d_gamma;
  int count=0;
  char filename[128];
  ofstream file;
